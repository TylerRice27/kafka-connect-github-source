...
public class GitHubSchemas {
        ...
        // NOTE with these section of fields he is aliasing the fields out as constants
        // Issue fields
        ...
        // NOTE we then use those constants above but down below in our Schema builder

        // The key schema keeps a structure of what your key should look like when
        // sending a message to Kafka
        // In other words the data structure for your unique Key ID
        // Key Schema
        ...
        // The data structure for your values that your messages contain.
        // Value Schema
        ...
        public static final Schema PR_SCHEMA = SchemaBuilder.struct().name(SCHEMA_VALUE_PR)
                        ...
                        // NOTE THIS IS an example of an optional field
                        // .field(PR_HTML_URL_FIELD, Schema.OPTIONAL_STRING_SCHEMA)
                        .optional() // Doing .optional() before .build() will make the whole Schema optional
                        .build();
        ...
        public static final Schema VALUE_SCHEMA = SchemaBuilder.struct().name(SCHEMA_VALUE_ISSUE)
                        ...
                        // NOTE these are referencing our Schemas up above which is a nested schema
                        // structure
